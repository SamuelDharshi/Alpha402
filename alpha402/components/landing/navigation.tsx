      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl" : "text-2xl"}`}>Alpha402</span>
            <span className={`text-muted-foreground font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5" : "text-xs mt-1"}`}>v1.0</span>
          </a>
        ...
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button 
              ...
              onClick={() => { setIsMobileMenuOpen(false); window.open(BOT_URL, '_blank'); }}
            >
              Open Bot
            </Button>
          </div>
