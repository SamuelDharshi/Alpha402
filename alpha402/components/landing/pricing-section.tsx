...
const plans = [
  ...
  {
    name: "Beta Launch",
    description: "Post-Hackathon Expansion",
    price: { monthly: null, annual: null },
    features: [
      "Multi-chain Expansion",
      "Agent Breeding (iNFTs)",
  ...
  {
    name: "Foundation",
    description: "Full Autonomous Economy",
    price: { monthly: null, annual: null },
    features: [
      "DAO Governance",
      "Agent Marketplace",
      "Institution Grade Security",
      "Direct L1/L2 Settlement",
      "Global P2P Mesh",
    ],
    cta: "Contact Team",
    popular: false,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Building the future of agentic finance during ETHGlobal Open Agents 2026.
          </p>
        </div>
